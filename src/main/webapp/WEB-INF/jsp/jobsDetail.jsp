												...
												<label for="jobTemplateFileLabel" class="input input-file">
													<div class="button" style="height: 25px;">
														<input type="file"
															...
															id="noticeToProceed" multiple> <span
												...
												<label for="jobTemplateFileLabel" class="input input-file">
													<div class="button" style="height: 25px;">
														<input type="file"
															...
															id="executedContract" multiple> <span
												...
												<label for="jobTemplateFileLabel" class="input input-file">
													<div class="button" style="height: 25px;">
														<input type="file"
															...
															class="legalRoleHighlights" name="rfi" id="rfi" multiple>
												...
												<label for="jobTemplateFileLabel" class="input input-file">
													<div class="button" style="height: 25px;">
														<input type="file"
															...
															id="communications" multiple> <span
												...
												<label for="jobTemplateFileLabel" class="input input-file">
													<div class="button" style="height: 25px;">
														<input type="file"
															...
															id="transmittalSheets" multiple> <span
												...
												<label for="jobTemplateFileLabel" class="input input-file">
													<div class="button" style="height: 25px;">
														<input type="file"
															...
															id="bidCommunications" multiple> <span
												...
												<label for="jobTemplateFileLabel" class="input input-file">
													<div class="button" style="height: 25px;">
														<input type="file"
															...
															id="californiaPreliminaryNotice"> <span
												...
												<label for="jobTemplateFileLabel" class="input input-file">
													<div class="button" style="height: 25px;">
														<input type="file"
															...
															id="otherDocuments" multiple> <span
